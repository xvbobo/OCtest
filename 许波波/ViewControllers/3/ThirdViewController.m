...
- (void)viewDidLoad {
    [super viewDidLoad];
//    CustomView * view = [[CustomView alloc] initWithFrame:CGRectMake(0, 64, self.view.frame.size.width, self.view.frame.size.height - 64)];
//    
//    view.backgroundColor = [UIColor blackColor];
//    [self.view addSubview:view];
   
    _viewContainer = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.width)];
    ...
    _takeButton.frame = CGRectMake(self.view.center.x, self.view.center.y,40,20);
