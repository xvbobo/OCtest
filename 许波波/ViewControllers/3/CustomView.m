...
//    [@"图片：" drawInRect:CGRectMake(10, 340, 80, 20) withFont:font];
    ...
    CGContextDrawPath(context, kCGPathStroke);//根据坐标绘制线
    //画笑脸弧线
    //左
    ...
    gradient1.colors = [NSArray arrayWithObjects:(id)[UIColor whiteColor].CGColor,(id)[UIColor blueColor].CGColor, nil];
